        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    return [3 /*break*/, 8];
                case 4: return [4 /*yield*/, tc.extract7z(download_path, output)];
                case 5:
                    ext_path = _b.sent();
                    return [3 /*break*/, 10];
                ...
                case 12:
                    error_2 = _b.sent();
                    throw new Error("Failed to extract BlitzMax version " + version + ": " + error_2);
                case 13: return [2 /*return*/, cache_path];
            }
        });
    });
}
